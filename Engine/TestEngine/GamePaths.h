...
// 3D Models
constexpr const char* M4A1_PATH = "Assets\\M4A1\\M4A1.FBX";
constexpr const char* HELICOPTER_PATH = "Assets\\Helicopter\\Lowpoly_Helicopter1.fbx";
constexpr const char* NANOSUIT_PATH = "Assets\\Nanosuit\\nanosuit.obj";
constexpr const char* THOR_HAMMER_PATH = "Assets\\ThorHammer\\thorhammer.obj";
